      ...
      <div className="min-h-screen bg-[#F7F7F7] flex flex-col md:flex-row overflow-hidden relative">
        ...
        <div className="hidden md:flex w-72 bg-white border-r border-gray-200 flex-col p-6 gap-8">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gray-50 animate-pulse"></div>
            <div className="w-32 h-6 rounded-lg bg-gray-50 animate-pulse"></div>
          </div>
          <div className="flex flex-col gap-4">
            <div className="w-full h-24 rounded-2xl bg-gray-50 animate-pulse"></div>
            <div className="w-full h-12 rounded-xl bg-gray-50 animate-pulse"></div>
            <div className="w-full h-12 rounded-xl bg-gray-50 animate-pulse"></div>
            <div className="w-full h-12 rounded-xl bg-gray-50 animate-pulse"></div>
            <div className="w-full h-12 rounded-xl bg-gray-50 animate-pulse"></div>
          </div>
        ...
        <div className="flex-1 flex flex-col p-4 md:p-8 gap-6">
          ...
          <div className="flex justify-between items-center">
            <div className="w-48 h-8 rounded-lg bg-gray-50 animate-pulse"></div>
            <div className="w-12 h-12 rounded-full bg-gray-50 animate-pulse"></div>
          </div>

          {/* Cards Skeleton */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="w-full h-40 rounded-3xl bg-gray-50 animate-pulse"></div>
            <div className="w-full h-40 rounded-3xl bg-gray-50 animate-pulse"></div>
            <div className="w-full h-40 rounded-3xl bg-gray-50 animate-pulse"></div>
          </div>
          ...
          <div className="absolute top-8 left-1/2 -translate-x-1/2 w-[90%] max-w-sm z-50 flex flex-col gap-2">
            {notifications.map(notification => (
              <div key={notification.id} className="animate-in slide-in-from-top-4 fade-in duration-300">
                <div className={`flex items-center gap-3 px-4 py-3 rounded-2xl shadow-2xl border backdrop-blur-xl relative overflow-hidden bg-white ${
                  notification.type === 'success' ? 'border-[#EA1D2C]/30 text-gray-900' : 'border-red-500/30 text-gray-900'
                }`}>
            ...
            {authMode === 'email_sent' ? (
              <div className="space-y-6">
                ...
                <button 
                  ...
                  className="w-full py-4 bg-gray-50 text-gray-900 rounded-2xl font-bold text-lg hover:bg-gray-100 transition-all flex items-center justify-center gap-2"
                >
              ...
              {authMode === 'register' && !inviteCode ? (
                <div className="p-8 bg-white rounded-3xl border border-gray-200 flex flex-col items-center text-center gap-4">
                  <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center text-gray-500 mb-2">
                    <Lock className="w-8 h-8" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Acesso Restrito</h3>
                    <p className="text-gray-500 text-sm leading-relaxed max-w-sm mx-auto">
                      O cadastro na plataforma é feito exclusivamente através de um <strong className="text-gray-900">link de convite oficial</strong> enviado pela sua empresa.
                    </p>
                  </div>
                </div>
              ) : (
                  ...
                  {authMode === 'register' && (
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full bg-white border border-gray-200 rounded-2xl p-4 text-gray-900 font-medium focus:ring-2 focus:ring-[#EA1D2C]/20 focus:border-[#EA1D2C] transition-all placeholder-gray-500"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input 
                          ...
                          className="w-full bg-white border border-gray-200 rounded-2xl p-4 pr-12 text-gray-900 font-medium focus:ring-2 focus:ring-[#EA1D2C]/20 focus:border-[#EA1D2C] transition-all placeholder-gray-500"
                          placeholder="••••••••"
                        />
                        <button
                          type="button"
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                {authMode === 'update_password' ? (
                  <button 
                    ...
                    className="text-sm font-bold text-gray-500 hover:text-[#EA1D2C] transition-colors flex items-center gap-2"
                  >
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div>
                      <h4 className="text-gray-900 font-bold text-sm mb-1">Novo por aqui?</h4>
                      <p className="text-gray-500 text-xs">Você precisa de um convite para criar sua conta.</p>
                    </div>
                    <button 
                      type="button"
                      onClick={() => {
                      ...
                      className="px-4 py-2 bg-gray-50 hover:bg-gray-100 text-gray-900 rounded-xl text-sm font-bold transition-colors whitespace-nowrap"
                    >
                      Tenho um convite
                    </button>
                  </div>
    ...
    <div className="min-h-screen bg-[#F7F7F7] text-gray-900 font-sans flex relative overflow-hidden">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-[#F7F7F7] border-r border-gray-200 z-40 sticky top-0 h-screen overflow-y-auto">
            ...
            <div className="flex items-center gap-3 relative z-10">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  <Bird className="w-3.5 h-3.5 text-[#EA1D2C] fill-[#EA1D2C]" />
                  <span className="text-sm font-medium text-gray-900">{formatPoints(currentUser.pontos)}</span>
                </div>
                <div className="flex items-center gap-2 mt-0.5">
                  <Trophy className="w-3.5 h-3.5 text-amber-400" />
                  <span className="text-sm font-medium text-gray-900">{formatPoints(currentUser.pontos_acumulados)}</span>
                </div>
              </div>
            </div>
        ...
        <div className="p-3 mt-auto space-y-1">
          <button onClick={() => setSoundEnabled(!soundEnabled)} className="flex items-center gap-3 w-full px-4 py-3 text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-colors font-medium text-sm">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden relative z-10">
        ...
        <header className="md:hidden bg-white/80 backdrop-blur-xl border-b border-gray-200 sticky top-0 z-40 px-4 py-3 flex flex-col gap-3 shadow-[0_4px_24px_rgba(234,29,44,0.05)]">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              <button type="button" onClick={() => setSoundEnabled(!soundEnabled)} className="p-2 -m-2 text-gray-500 hover:text-gray-900 transition-colors cursor-pointer" title={soundEnabled ? 'Desativar som' : 'Ativar som'}>
                {soundEnabled ? <Volume2 className="w-5 h-5" /> : <VolumeX className="w-5 h-5" />}
              </button>
              <button type="button" onClick={() => setShowRankingsModal(true)} className="p-2 -m-2 text-gray-500 hover:text-gray-900 transition-colors cursor-pointer" title="Ver todos os rankings">
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              ...
              <div className="bg-gray-50 rounded-lg p-2 border border-gray-200 flex flex-col items-center justify-center">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-sm font-black text-gray-900">{formatPoints(currentUser.pontos_acumulados)}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl shadow-2xl border border-gray-200 bg-white/95 backdrop-blur-xl relative overflow-hidden">
              ...
              <div className="flex-1">
                ...
                <button 
                  ...
                  className="w-full py-2 bg-gray-50 hover:bg-gray-100 text-gray-900 rounded-xl text-sm font-bold transition-colors border border-gray-200"
                >
                  Estou ciente
                </button>
              </div>
        ...
        {bonificacoes.filter(p => p.usuario_id === currentUser.id && !p.lida).map(bonificacao => (
          <div key={bonificacao.id} className="fixed top-20 right-4 z-40 w-[90%] md:w-auto max-w-md animate-in slide-in-from-right-8 fade-in duration-500">
            <div className="flex items-start gap-4 p-5 rounded-2xl shadow-2xl border border-gray-200 bg-white/95 backdrop-blur-xl relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-[#EA1D2C]/50"></div>
              <div className="p-2 bg-gray-50 rounded-xl text-[#EA1D2C] shrink-0">
                <CheckCircle2 className="w-6 h-6" />
              </div>
              <div className="flex-1">
                <h3 className="text-gray-900 font-black text-lg mb-1">Bonificação Recebida</h3>
                <p className="text-gray-600 text-sm font-medium mb-2">Você ganhou <span className="text-[#EA1D2C] font-bold">{bonificacao.pontos} pontos</span>!</p>
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 mb-3">
                  <p className="text-gray-500 text-xs uppercase font-bold tracking-wider mb-1">Motivo:</p>
                  <p className="text-gray-600 text-sm italic">"{bonificacao.motivo}"</p>
                </div>
                <button 
        ...
        >
          ...
          >
            <div className={`bg-white border border-gray-200 rounded-full p-2 shadow-lg ${isRefreshing ? 'animate-spin' : ''}`} style={{ transform: `rotate(${pullDistance * 2}deg)` }}>
                ...
                <div className="space-y-12">
                  ...
                  {availableProducts.length === 0 && lockedProducts.length === 0 ? (
                    <div className="p-12 text-center text-gray-500 font-medium bg-gray-50 rounded-3xl border border-gray-200 flex flex-col items-center justify-center gap-4 relative overflow-hidden">
                      ...
                      <h3 className="text-2xl font-black text-gray-900 tracking-tight relative z-10">Loja em reabastecimento...</h3>
                      <p className="text-sm text-gray-500 max-w-sm relative z-10">Nenhum prêmio disponível no momento. Continue juntando pontos enquanto preparamos novidades!</p>
                    </div>
                  ) : (
                    <>
                      {availableProducts.length > 0 && (
                        ...
                        {availableProducts.map(produto => {
                          ...
                          return (
                          <div key={produto.id} className={`bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col group border ${isPremium ? 'border-amber-500/50 hover:border-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.15)] hover:shadow-[0_0_25px_rgba(245,158,11,0.3)]' : 'border-[#EA1D2C]/30 hover:border-[#EA1D2C]'}`}>
                            ...
                            <div className="p-5 flex flex-col flex-1">
                              ...
                              <div className="flex items-center gap-2 mb-6">
                                <span className="text-xs font-bold px-2.5 py-1 bg-gray-50 text-gray-500 rounded-md border border-gray-200">
                  ...
                  {lockedProducts.length > 0 && (
                    <div>
                      <h2 className="text-xl font-black text-gray-500 mb-6 flex items-center gap-2">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {lockedProducts.map(produto => {
                          ...
                          return (
                            <div key={produto.id} className={`bg-white rounded-3xl overflow-hidden shadow-sm transition-all duration-300 flex flex-col border ${isPremium && !isOutOfStock ? 'border-amber-500/20' : 'border-gray-200'} ${isOutOfStock ? 'opacity-70' : ''}`}>
                              <div className="aspect-[4/3] w-full bg-white relative overflow-hidden">
                                <img 
                                  src={produto.imagem_url} 
                                  alt={produto.nome}
                              ...
                              <div className="p-5 flex flex-col flex-1">
                                <h3 className="text-lg font-bold text-gray-600 leading-tight mb-1">{produto.nome}</h3>
                                <p className="text-sm text-gray-500 mb-2 line-clamp-2">{produto.descricao}</p>
                                {produto.regras && <p className="text-xs text-[#EA1D2C]/70 mb-4 font-medium">Regras: {produto.regras}</p>}
                                
                                <div className="flex items-center gap-2 mb-4">
                                  <span className="text-[10px] font-bold px-2 py-0.5 bg-gray-50 text-gray-500 rounded-md border border-gray-200 uppercase tracking-wider">
                                    {produto.estoque} {produto.estoque === 1 ? 'disponível' : 'disponíveis'}
                                  </span>
                                </div>
                                ...
                                {!isOutOfStock && (
                                  <div className="mb-6 space-y-2">
                                    <div className="flex justify-between text-xs font-bold">
                                      ...
                                      <span className="text-[#EA1D2C]">Faltam {formatPoints(pointsNeeded)} pts</span>
                                    </div>
                                ...
                                <div className="mt-auto">
                                  <button 
                                    disabled
                                    className="w-full py-3 rounded-2xl text-sm font-bold flex items-center justify-center gap-2 bg-gray-50 text-gray-500 cursor-not-allowed border border-gray-200"
                                  >
                    ...
                    {resgates.filter(r => r.usuario_id === currentUser.id).map(resgate => (
                      <div key={resgate.id} className="p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 hover:bg-gray-50 transition-colors">
                        <div className="min-w-0 flex-1 w-full">
                          <p className="font-bold text-gray-900 text-lg truncate">{resgate.produto_nome}</p>
        ...
        {activeTab === 'enviar' && (
          <div className="space-y-6 animate-in fade-in duration-300 max-w-xl mx-auto">
            {!selectedTarefa ? (
                ...
                <div className="space-y-4">
                  {tarefas.filter(t => t.ativo !== false).length === 0 ? (
                    <div className="p-12 text-center text-gray-500 font-medium bg-gray-50 rounded-3xl border border-gray-200 flex flex-col items-center justify-center gap-4 relative overflow-hidden">
                      ...
                      <h3 className="text-2xl font-black text-gray-900 tracking-tight relative z-10">Nenhuma missão no momento</h3>
                      <p className="text-sm text-gray-500 max-w-sm relative z-10">Fique de olho! Novas missões podem aparecer a qualquer momento para você ganhar mais pontos.</p>
                    </div>
                  ) : (
                    tarefas.filter(t => t.ativo !== false).map(tarefa => (
                      <div 
                        ...
                        className="bg-white p-5 rounded-3xl border border-gray-200 shadow-sm flex items-center justify-between cursor-pointer hover:border-[#EA1D2C]/50 hover:bg-gray-50 transition-all group overflow-hidden relative active:scale-[0.98]"
                      >
                        <div className="flex items-center gap-4 z-10">
                          {tarefa.imagem_url ? (
                            <img src={tarefa.imagem_url} alt={tarefa.nome} loading="lazy" className="w-16 h-16 rounded-2xl object-cover border border-gray-200 shrink-0 group-hover:scale-105 transition-transform" />
                          ) : (
                            <div className="w-16 h-16 bg-[#EA1D2C]/20 rounded-2xl flex items-center justify-center group-hover:scale-105 transition-transform border border-[#EA1D2C]/30 shrink-0">
                              <Cpu className="w-8 h-8 text-[#EA1D2C]" />
                            </div>
                          )}
                          <div>
                            <h3 className="font-bold text-gray-900 text-lg">{tarefa.nome}</h3>
                            {tarefa.descricao && <p className="text-sm text-gray-500 mt-0.5 line-clamp-2">{tarefa.descricao}</p>}
                            {tarefa.regras && <p className="text-xs text-[#EA1D2C] mt-1 font-medium">Regras: {tarefa.regras}</p>}
                            <div className="flex items-center gap-1 mt-2">
                              <Star className="w-4 h-4 text-[#EA1D2C] fill-[#EA1D2C]" />
                              <span className="text-sm font-black text-[#EA1D2C]">+{formatPoints(tarefa.pontos)} pts</span>
                            </div>
                          </div>
                        </div>
                        <ChevronRight className="w-6 h-6 text-gray-600 group-hover:text-[#EA1D2C] transition-colors z-10" />
                      </div>
                    ))
                  )}
                </div>
                  ...
                  {submissoes.filter(s => s.usuario_id === currentUser.id).length === 0 ? (
                    <div className="p-10 text-center text-gray-500 font-medium bg-gray-50 rounded-3xl border border-gray-200 flex flex-col items-center justify-center gap-3 relative overflow-hidden">
                      ...
                      <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mb-2 relative">
                        ...
                        <Camera className="w-8 h-8 text-gray-500 relative z-10" />
                      </div>
                      <h3 className="text-xl font-bold text-gray-900 relative z-10">Nenhuma missão enviada</h3>
                      <p className="text-sm text-gray-500 max-w-xs relative z-10">Escolha uma missão acima, envie sua evidência e comece a ganhar pontos!</p>
                    </div>
                  ) : (
                    <div className="space-y-3">
                      {submissoes.filter(s => s.usuario_id === currentUser.id).map(sub => (
                        <div key={sub.id} className="p-4 bg-white rounded-2xl border border-gray-200 flex flex-col gap-3 w-full overflow-hidden">
                          <div className="flex justify-between items-start gap-4">
                            <div className="min-w-0 flex-1 w-full">
                              <h3 className="font-bold text-gray-900 truncate">{sub.tarefa_nome}</h3>
                              <p className="text-xs text-gray-500 mt-1">{new Date(sub.data_envio).toLocaleDateString('pt-BR')}</p>
                            </div>
                            <div className={`px-3 py-1 rounded-full text-xs font-bold border shrink-0 ${
                              ...
                              sub.status === 'rejeitado' ? 'bg-gray-50 text-gray-500 border-gray-200' :
                          ...
                          {sub.url_prova && (
                            <div 
                              className="w-full h-24 rounded-xl overflow-hidden border border-gray-200 relative cursor-pointer group mt-2"
                          ...
                          {sub.status === 'rejeitado' && sub.motivo_rejeicao && (
                            <div className="bg-gray-50 border border-gray-200 rounded-xl p-3 mt-2">
                              <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Motivo da Rejeição:</p>
                              <p className="text-sm text-gray-600 italic break-words whitespace-pre-wrap w-full overflow-y-auto max-h-32">"{sub.motivo_rejeicao}"</p>
                            </div>
                          )}
                        </div>
                      ))}
              ...
              <div className="bg-white rounded-[2rem] shadow-sm border border-gray-200 p-6 md:p-8 space-y-6">
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#EA1D2C] font-bold">Valendo {formatPoints(tarefas.find(t => t.id === selectedTarefa)?.pontos)} pts</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <textarea 
                      ...
                      rows={3}
                      className="w-full bg-white border border-gray-200 rounded-2xl p-4 text-gray-900 font-medium focus:ring-2 focus:ring-[#EA1D2C]/50 focus:border-transparent transition-colors resize-none placeholder-gray-600"
                  ...
                  <div>
                    ...
                    <div className="relative border-2 border-dashed border-gray-300 rounded-3xl bg-white p-8 text-center cursor-pointer hover:bg-gray-50 hover:border-[#EA1D2C]/50 transition-colors min-h-[200px] flex flex-col items-center justify-center overflow-hidden group">
                      <input 
                        type="file"
                        accept="image/*,video/*"
                      ...
                      {previewUrl ? (
                        <div className="absolute inset-0 w-full h-full">
                          ...
                          <div className="absolute inset-0 bg-white/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                            <span className="bg-white text-gray-900 font-bold px-5 py-2.5 rounded-full text-sm shadow-lg border border-gray-200">Trocar arquivo</span>
                          </div>
                        </div>
                      ) : (
                        <div className="flex flex-col items-center gap-3 pointer-events-none">
                          <div className="w-16 h-16 rounded-full bg-white shadow-sm flex items-center justify-center group-hover:scale-110 transition-transform border border-gray-200">
                            <Camera className="w-7 h-7 text-[#EA1D2C]" />
                          </div>
                          <div>
                            <span className="block font-bold text-gray-600">Toque para abrir a galeria</span>
        ...
        {activeTab === 'mural' && currentUser?.cargo === 'admin' && (
          <div className="space-y-6 animate-in fade-in duration-300 max-w-2xl mx-auto pb-20">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-black text-gray-900 tracking-tight">Mural de Atividades</h1>
              <p className="text-gray-500 mt-2 font-medium">Veja o que a galera está conquistando!</p>
            </div>
              ...
              if (atividades.length === 0) {
                return (
                  <div className="p-12 text-center text-gray-500 font-medium bg-gray-50 rounded-3xl border border-gray-200 flex flex-col items-center justify-center gap-4 relative overflow-hidden">
                    ...
                    <h3 className="text-2xl font-black text-gray-900 tracking-tight relative z-10">O mural está silencioso...</h3>
                ...
                <div className="space-y-4 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-200 before:to-transparent">
                  {atividades.map((atividade) => (
                    <div key={atividade.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                      ...
                      {/* Content Card */}
                      <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-4 rounded-2xl bg-white border border-gray-200 shadow-sm hover:border-gray-200 hover:bg-gray-50 transition-all duration-300 hover:-translate-y-1 overflow-hidden relative group/card">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                          <img src={atividade.user?.avatar} alt={atividade.user?.nome} className="w-8 h-8 rounded-full object-cover border border-gray-200 shrink-0" />
                          <div className="min-w-0">
                            <p className="text-sm font-bold text-gray-900 truncate">{atividade.user?.nome}</p>
                        ...
                        {atividade.type === 'missao' ? (
                          ...
                          <p className="text-sm text-gray-600 break-words">
                            Recebeu uma bonificação de <span className="text-[#EA1D2C] font-bold whitespace-nowrap">+{formatPoints(atividade.data.pontos)} pts</span>!
                          </p>
                        ) : (
                          <p className="text-sm text-gray-600 break-words">
                            Resgatou uma recompensa por <span className="text-[#EA1D2C] font-bold whitespace-nowrap">{formatPoints(atividade.data.preco_pontos)} pts</span>!
                          </p>
                        )}
                      </div>
                    </div>
            ...
            {!loadOlder && (
              <div className="flex justify-center mt-8">
                <button 
                  ...
                  className="px-6 py-3 bg-gray-50 hover:bg-gray-100 text-gray-900 font-bold rounded-xl transition-colors border border-gray-200"
                >
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <section className="bg-white/80 backdrop-blur-xl rounded-[2rem] border border-gray-200 shadow-sm overflow-hidden mb-8 relative">
              ...
              <div className="p-6 border-b border-gray-200 bg-transparent relative z-10">
                <h2 className="text-lg font-black text-gray-900 flex items-center gap-2">
                  <Gift className="w-5 h-5 text-[#EA1D2C]" /> Fila de Avaliação de Prêmios
                </h2>
              </div>
              ...
              <div className="p-4 relative z-10">
                {resgates.filter(r => r.status === 'pendente').length === 0 ? (
                  <div className="p-12 text-center text-gray-500 font-medium bg-gray-50 rounded-2xl border border-gray-200 flex flex-col items-center justify-center gap-4 relative overflow-hidden">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 relative z-10">Tudo limpo! ✨</h3>
                    <p className="text-sm text-gray-500 relative z-10">Nenhum resgate pendente de aprovação no momento.</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {resgates.filter(r => r.status === 'pendente').map(resgate => (
                      <div key={resgate.id} className="p-5 flex flex-col md:flex-row gap-5 justify-between items-start md:items-center bg-white/80 hover:bg-gray-50 rounded-2xl transition-all border border-gray-200 hover:border-[#EA1D2C]/30 hover:shadow-md w-full overflow-hidden">
                        <div className="space-y-2 flex-1 min-w-0 w-full">
                          <div className="flex items-center gap-2">
                            <span className="font-bold text-gray-900 text-lg truncate select-text selection:bg-[#EA1D2C]/30 selection:text-gray-900">{resgate.usuario_nome}</span>
                            <span className="px-2.5 py-1 bg-[#EA1D2C]/10 text-[#EA1D2C] text-xs font-bold rounded-lg border border-[#EA1D2C]/20 shadow-sm whitespace-nowrap">-{resgate.preco_pontos} pts</span>
                          </div>
                          <div className="text-sm font-bold text-gray-600 truncate select-text selection:bg-[#EA1D2C]/30 selection:text-gray-900">{resgate.produto_nome}</div>
                        </div>
            ...
            <div className="flex flex-col gap-8">
              {/* GERENCIAR MISSÕES */}
              <section className="bg-white/80 backdrop-blur-xl rounded-[2rem] border border-gray-200 p-6 flex flex-col shadow-sm relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#EA1D2C]/10 blur-[40px] pointer-events-none"></div>
                <h2 className="text-lg font-black text-gray-900 flex items-center gap-2 mb-6 flex-shrink-0 relative z-10">
                  <Cpu className="w-5 h-5 text-[#EA1D2C]" /> Gerenciar Missões
                </h2>
                    ...
                    tarefas.map(tarefa => (
                      ...
                      >
                        <div className="flex items-center gap-3 min-w-0 flex-1">
                          ...
                          {tarefa.imagem_url ? (
                            <img src={tarefa.imagem_url} alt={tarefa.nome} loading="lazy" className="w-12 h-12 rounded-xl object-cover bg-[#F7F7F7] border border-gray-200 shrink-0" />
                          ) : (
                            <div className="w-12 h-12 rounded-xl bg-[#F7F7F7] border border-gray-200 flex items-center justify-center shrink-0">
                              <Camera className="w-5 h-5 text-gray-600" />
                            </div>
                          )}
                          <div className="min-w-0 flex-1">
                            <p className="font-bold text-gray-900 text-sm truncate">{tarefa.nome}</p>
                            <p className="text-xs text-[#EA1D2C] font-bold">{tarefa.pontos} pts</p>
                          </div>
                        </div>
                  ...
                  <form onSubmit={editingTarefa ? handleUpdateTarefa : handleCreateTarefa} className="space-y-4">
                    <div>
                      <input 
                        ...
                        className="w-full bg-white border border-gray-200 rounded-xl p-3 text-gray-900 font-medium focus:ring-2 focus:ring-[#EA1D2C]/50 focus:border-transparent transition-colors text-sm placeholder-gray-600"
                    ...
                    <div>
                      <textarea 
                        ...
                        className="w-full bg-white border border-gray-200 rounded-xl p-3 text-gray-900 font-medium focus:ring-2 focus:ring-[#EA1D2C]/50 focus:border-transparent transition-colors text-sm placeholder-gray-600 min-h-[80px] resize-none"
                    ...
                    <div className="flex gap-3">
                      <input 
                        ...
                        className="w-1/3 bg-white border border-gray-200 rounded-xl p-3 text-gray-900 font-medium focus:ring-2 focus:ring-[#EA1D2C]/50 focus:border-transparent transition-colors text-sm placeholder-gray-600"
                        placeholder="Pontos"
                      />
                      <div className="flex-1 flex items-center gap-3">
                        {newTarefaPreview && (
                          newTarefaFile?.type.startsWith('video/') ? (
                            <video src={newTarefaPreview} className="w-10 h-10 rounded-lg object-cover border border-gray-200 flex-shrink-0" controls />
                          ) : (
                            <img src={newTarefaPreview} alt="Preview" className="w-10 h-10 rounded-lg object-cover border border-gray-200 flex-shrink-0" />
                          )
                        )}
                        <div className="flex-1">
                          <input 
                            ...
                            className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-bold file:bg-[#EA1D2C]/10 file:text-[#EA1D2C] hover:file:bg-[#EA1D2C]/20 cursor-pointer"
                          />
                        </div>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      {editingTarefa && (
                        <button 
                          ...
                          className="px-4 py-3 bg-gray-50 text-gray-500 rounded-xl font-bold hover:bg-gray-100 transition-colors text-sm border border-gray-200"
                        >
                          Cancelar
                        </button>
                      )}
              ...
              <section className="bg-white/80 backdrop-blur-xl rounded-[2rem] border border-gray-200 p-6 flex flex-col shadow-sm relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#EA1D2C]/10 blur-[40px] pointer-events-none"></div>
                <h2 className="text-lg font-black text-gray-900 flex items-center gap-2 mb-6 flex-shrink-0 relative z-10">
                  <Gift className="w-5 h-5 text-[#EA1D2C]" /> Gerenciar Prêmios
                </h2>
                    ...
                    products.map(produto => (
                      ...
                      >
                        <div className="flex items-center gap-3 min-w-0 flex-1">
                          ...
                          <img src={produto.imagem_url} alt={produto.nome} loading="lazy" className="w-12 h-12 rounded-xl object-cover bg-[#F7F7F7] border border-gray-200 shrink-0" />
                          <div className="min-w-0 flex-1">
                            <p className="font-bold text-gray-900 text-sm truncate">{produto.nome}</p>
                            <p className="text-xs text-[#EA1D2C] font-bold">{produto.preco_pontos} pts • {produto.estoque} em estoque</p>
                          </div>
                        </div>
                        <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                          <button 
                  ...
                  <form onSubmit={editingProduto ? handleUpdateProduto : handleCreateProduto} className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-2 mb-2 flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">OU URL</span>
                        <div className="h-px bg-gray-200 flex-1"></div>
                      </div>
                      <input 
                        type="text" 
                        ...
                        className="w-full bg-white border border-gray-200 rounded-xl p-3 text-gray-900 font-medium focus:ring-2 focus:ring-[#EA1D2C]/20 focus:bg-gray-50 transition-colors text-sm"
            ...
            <section className="bg-white/80 backdrop-blur-xl rounded-[2rem] border border-gray-200 shadow-sm overflow-hidden mt-8 relative">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-32 bg-[#EA1D2C]/10 blur-[50px] pointer-events-none"></div>
              <div className="p-6 border-b border-gray-200 bg-transparent relative z-10">
                <h2 className="text-lg font-black text-gray-900 flex items-center gap-2">
                  <Ticket className="w-5 h-5 text-[#EA1D2C]" /> Histórico de Resgates
                </h2>
              </div>
                ...
                {resgates.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {resgates.map(resgate => (
                      <div key={resgate.id} className={`p-5 flex flex-col md:flex-row gap-5 justify-between items-start md:items-center rounded-2xl transition-all border w-full overflow-hidden ${resgate.usado ? 'bg-[#F7F7F7] border-gray-200 opacity-75' : 'bg-white/80 border-gray-200 hover:border-[#EA1D2C]/30 hover:bg-gray-50 hover:shadow-md'}`}>
                        <div className="space-y-1 flex-1 min-w-0 w-full">
                          <div className="flex items-center gap-2">
                            <span className="font-bold text-gray-900 text-lg truncate select-text selection:bg-[#EA1D2C]/30 selection:text-gray-900">{resgate.usuario_nome}</span>
                            <span className="text-sm text-gray-500 shrink-0">• {new Date(resgate.data_resgate).toLocaleDateString('pt-BR')}</span>
                          </div>
                          <div className="text-sm font-bold text-gray-600 select-text selection:bg-[#EA1D2C]/30 selection:text-gray-900">{resgate.produto_nome}</div>
                        </div>
                        
                        <div className="flex gap-2 w-full md:w-auto">
                          {resgate.usado ? (
                            <span className="flex-1 md:flex-none px-5 py-3 bg-gray-50 text-gray-500 rounded-xl text-sm font-bold flex items-center justify-center gap-2 border border-gray-200">
            ...
            <section className="bg-white/80 backdrop-blur-xl rounded-[2rem] border border-gray-200 shadow-sm overflow-hidden mt-8 relative">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/2 h-32 bg-[#EA1D2C]/10 blur-[50px] pointer-events-none"></div>
              <div className="p-6 border-b border-gray-200 bg-transparent relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <h2 className="text-lg font-black text-gray-900 flex items-center gap-2">
                  <Shield className="w-5 h-5 text-[#EA1D2C]" /> Gerenciar Usuários
                </h2>
                <input 
                  type="text" 
                  ...
                  className="w-full sm:w-64 bg-white border border-gray-200 rounded-xl px-4 py-2 text-sm text-gray-900 focus:outline-none focus:border-[#EA1D2C]/50 transition-colors"
                />
              </div>
              ...
              <div className="p-4 relative z-10">
                <div className="space-y-3">
                  {users
                    ...
                    .map(user => (
                    <div key={user.id} className="p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white/80 hover:bg-gray-50 rounded-2xl transition-all border border-gray-200 hover:border-[#EA1D2C]/30 hover:shadow-md gap-4 w-full overflow-hidden">
                      <div className="flex items-center gap-3 w-full sm:w-auto min-w-0">
                        <img src={user.avatar} alt={user.nome} loading="lazy" className="w-10 h-10 rounded-full bg-white border border-gray-200 object-cover shrink-0" />
                        <div className="min-w-0 flex-1">
                      ...
                      <div className="flex items-center gap-4 w-full sm:w-auto shrink-0">
                        <div className="text-right">
                          <p className="text-sm font-bold text-[#EA1D2C]">{user.pontos} pts atuais</p>
                        ...
                        <div className="flex gap-2 ml-auto sm:ml-0 flex-wrap justify-end">
                          <button 
                            ...
                            className={`px-4 py-2 bg-gray-50 hover:bg-gray-100 rounded-xl text-sm font-bold transition-colors flex items-center justify-center gap-2 border border-gray-200 ${user.oculto_ranking ? 'text-gray-500' : 'text-gray-900'}`}
                          ...
                          <button 
                            ...
                            className="px-4 py-2 bg-gray-50 text-[#EA1D2C] hover:bg-gray-100 rounded-xl text-sm font-bold transition-colors flex items-center justify-center gap-2 border border-gray-200"
                  ...
                  {users.length === 0 && (
                    <div className="p-8 text-center text-gray-500 font-medium bg-white rounded-2xl m-2 border border-gray-200">Nenhum usuário encontrado.</div>
                  )}
                  {users.length > 0 && users.filter(u => u.nome.toLowerCase().includes(debouncedSearchUser.toLowerCase()) || u.email.toLowerCase().includes(debouncedSearchUser.toLowerCase())).length === 0 && (
                    <div className="p-8 text-center text-gray-500 font-medium bg-white rounded-2xl m-2 border border-gray-200">Nenhum usuário corresponde à busca.</div>
                  )}
            ...
            {isReportLoading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  {/* Bar Chart */}
                  <div className="lg:col-span-2 bg-white/80 backdrop-blur-xl p-6 rounded-[2rem] border border-gray-200 shadow-sm">
                    <h3 className="text-lg font-bold text-gray-900 mb-6">Missões por Usuário (Top 10)</h3>
      ...
      {confirmResgate && (
        ...
        >
          <div 
            className="w-full max-w-sm bg-white rounded-[32px] border border-gray-200 p-6 flex flex-col items-center text-center shadow-2xl animate-in zoom-in-95 duration-200"
          ...
          >
            ...
            <h3 className="text-2xl font-black text-gray-900 mb-2 tracking-tight">Confirmar Resgate</h3>
            
            <p className="text-gray-500 mb-6">
              Deseja realmente resgatar <strong className="text-gray-900">{confirmResgate.nome}</strong> por <strong className="text-[#EA1D2C]">{formatPoints(confirmResgate.preco_pontos)} pts</strong>?
            </p>
            
            <div className="flex gap-3 w-full">
              <button 
                onClick={() => setConfirmResgate(null)}
                className="flex-1 py-3.5 rounded-2xl text-sm font-bold bg-gray-50 text-gray-900 hover:bg-gray-100 transition-colors"
              >
                Cancelar
              </button>
              <button 
      ...
      {showRankingsModal && (
        ...
        >
          ...
          >
            ...
            <div className="p-6 relative z-10 border-b border-gray-200 flex justify-between items-center">
              <h2 className="text-xl font-black text-gray-900 flex items-center gap-2">
                <Trophy className="w-6 h-6 text-[#EA1D2C]" />
                Níveis do Ranking
              </h2>
              <button 
                onClick={() => setShowRankingsModal(false)}
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className={`font-bold ${isCurrent ? tier.color : 'text-gray-600'}`}>
                          {tier.name}
                          {isCurrent && <span className="ml-2 text-[10px] bg-gray-100 text-gray-900 px-2 py-0.5 rounded-full uppercase tracking-wider">Você</span>}
                        </h3>
      ...
      {lightboxImage && (
        <div 
          className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-white/95 backdrop-blur-md animate-in fade-in duration-300"
